...
public class Easing : MonoBehaviour
{
    ...
    public static Function GetEasingFunction(Ease easingFunction)
    {
        ...
        if (easingFunction == Ease.EaseOutInQuad)
        {
        ...
        if (easingFunction == Ease.EaseOutInCubic)
        {
        ...
        if (easingFunction == Ease.EaseOutInQuart)
        {
        ...
        if (easingFunction == Ease.EaseOutInQuint)
        {
        ...
        if (easingFunction == Ease.EaseOutInSine)
        {
        ...
        if (easingFunction == Ease.EaseOutInExpo)
        {
        ...
        if (easingFunction == Ease.EaseOutInCirc)
        {
        ...
        if (easingFunction == Ease.EaseOutInBounce)
        {
        ...
        if (easingFunction == Ease.EaseOutInBack)
        {
        ...
        if (easingFunction == Ease.EaseOutInElastic)
        {
